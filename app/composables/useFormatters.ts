export function useFormatters() {
  ...
  const methodText = (method: string) => ({ MANUAL: '수동 입력', HTML_SELECTOR: 'HTML 자동 수집', JSON_LD: 'JSON-LD 자동 수집', CAFE24_API: '카페24 자동 수집', NAVER_SEARCH_API: '네이버 검색 API' }[method] || method)
