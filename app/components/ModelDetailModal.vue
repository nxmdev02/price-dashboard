...
import { ArrowLeft, Link2, Pencil, Play, Save, X } from '@lucide/vue'
...
watch(() => props.productId, () => { editingMapping.value = null; rebuild() }, { immediate: true })
